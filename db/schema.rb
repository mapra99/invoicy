...
ActiveRecord::Schema.define(version: 20_211_220_032_719) do
  ...
  create_table 'client_emails', force: :cascade do |t|
    ...
    t.index %w[client_id email], name: 'index_client_emails_on_client_id_and_email', unique: true
  ...
  create_table 'invoices', force: :cascade do |t|
    ...
    t.index %w[uuid client_id], name: 'index_invoices_on_uuid_and_client_id'
    t.index %w[uuid user_id client_id], name: 'index_invoices_on_uuid_and_user_id_and_client_id', unique: true
    t.index %w[uuid user_id], name: 'index_invoices_on_uuid_and_user_id'
  ...
  create_table 'items', force: :cascade do |t|
    ...
    t.index %w[name user_id], name: 'index_items_on_name_and_user_id', unique: true
